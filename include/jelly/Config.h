...
namespace jelly
{
	...
	namespace Config
	{
		...
		enum Id : uint32_t
		{
			...
			ID_PENDING_STORE_WAL_COUNT_LIMIT,
		...
		static const Info INFO[] = 
		{
			...
			/* ID_PENDING_STORE_WAL_COUNT_LIMIT */          { TYPE_SIZE,     "pending_store_wal_count_limit",          "50",          false,
			   "HouseKeepingAdvisor: If total number of WALs exceed this a pending store flush will be triggered." },
