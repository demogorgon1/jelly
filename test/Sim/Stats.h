...
namespace jelly::Test::Sim
{
	...
	namespace Stats
	{
		...
		enum Id : uint32_t
		{
			...
			ID_GS_C_NEED_UNLOCK_TIME,
			ID_GS_C_WAITING_FOR_UNLOCK_TIME,
			...
			ID_GS_C_NEED_UNLOCK_CUR_TIME,
			ID_GS_C_WAITING_FOR_UNLOCK_CUR_TIME,
			ID_GS_C_INIT_NUM,
			...
			ID_GS_C_NEED_UNLOCK_NUM,
			ID_GS_C_WAITING_FOR_UNLOCK_NUM,
		...
		static const Stat::Info EXTRA_APPLICATION_STATS[] =
		{
			...
			/* ID_GS_C_NEED_UNLOCK_TIME */               { Stat::TYPE_SAMPLER, "gs_c_need_unlock_time",                0,          Stat::TIME_SAMPLER_HISTOGRAM_BUCKETS },
			/* ID_GS_C_WAITING_FOR_UNLOCK_TIME */        { Stat::TYPE_SAMPLER, "gs_c_waiting_for_unlock_time",         0,          Stat::TIME_SAMPLER_HISTOGRAM_BUCKETS },
			...
			/* ID_GS_C_NEED_UNLOCK_CUR_TIME */           { Stat::TYPE_SAMPLER, "gs_c_need_unlock_cur_time",            0,          Stat::TIME_SAMPLER_HISTOGRAM_BUCKETS },
			/* ID_GS_C_WAITING_FOR_UNLOCK_CUR_TIME */    { Stat::TYPE_SAMPLER, "gs_c_waiting_for_unlock_cur_time",     0,          Stat::TIME_SAMPLER_HISTOGRAM_BUCKETS },
			...
			/* ID_GS_C_NEED_UNLOCK_NUM */				 { Stat::TYPE_GAUGE,   "gs_c_need_unlock_num",                 0,          {} },
			/* ID_GS_C_WAITING_FOR_UNLOCK_NUM */		 { Stat::TYPE_GAUGE,   "gs_c_waiting_for_unlock_num",          0,          {} },
			...
			/* ID_C_WAITING_FOR_DISCONNECTION_TIME */	 { Stat::TYPE_SAMPLER, "c_waiting_for_disconnection_time",     0,          Stat::TIME_SAMPLER_HISTOGRAM_BUCKETS },
			...
			/* ID_C_WAITING_FOR_DISCONNECTION_CUR_TIME */{ Stat::TYPE_SAMPLER, "c_waiting_for_disconnection_cur_time", 0,          Stat::TIME_SAMPLER_HISTOGRAM_BUCKETS },
			...
			/* ID_C_WAITING_FOR_DISCONNECTION_NUM */     { Stat::TYPE_GAUGE,   "c_waiting_for_disconnection_num",      0,          {} },
			/* ID_C_DISCONNECTED_NUM */				     { Stat::TYPE_GAUGE,   "c_disconnected_num",                   0,          {} },

			/* ID_CLIENT_LIMIT */                        { Stat::TYPE_GAUGE,   "client_limit",                         0,          {} }
		};
